...
export default function MusicPage() {
  return (
    <>
      <Head>
        <title>Music & Poetry | Harsh Parmar</title>
        <meta name="description" content="Explore the musical and poetic side of Harsh Parmar. Read about his journey with rap and his perspective on poetry as a form of expression." />
      </Head>
