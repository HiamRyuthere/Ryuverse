...
const thoughts = [
  {
    ...
    excerpt:
      "AI won't replace you, but the person who knows how to use it might. Or will they? A look past the marketing hype and into the real-world costs and applications of artificial intelligence.",
  },
  {
    ...
    excerpt:
      "You get the things you want, the things you need, yet satisfaction remains a distant shore. A reflection on the endless chase for more and the nature of Maya.",
  },
  {
    ...
    excerpt:
      "Learning tech feels like a survival skill. But is that what makes us human? A thought on how art, poetry, and music are the true expressions of our humanity.",
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A collection of musings and articles by Harsh Parmar on minimalism, programming, philosophy, and well-being."
        />
      </Head>
